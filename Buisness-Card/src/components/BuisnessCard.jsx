export function BuisnessCard(props) {
  return (<div style={styles.card}>
    ...
    <div style={styles.socialLinks}>
      <a href={props.twitter} target="_blank" rel="noopener noreferrer" style={styles.link}>Twitter</a>
      <a href={props.otherSocialMedia} target="_blank" rel="noopener noreferrer" style={styles.link}>{props.otherSocialMedia.label}  </a>
    </div>
  </div>
  )
}
